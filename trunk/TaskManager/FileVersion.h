...
public: 
	...
	CString GetLegalTrademarks()  {return QueryValue(_T("LegalTrademarks")); };
	CString GetPrivateBuild()	  {return QueryValue(_T("PrivateBuild"));	 };
	CString GetSpecialBuild()	  {return QueryValue(_T("SpecialBuild"));	 };

	CString GetFileAttributes();
	CString GetFileConsturctTime();
	CString GetFileModifiedTime();
	CString GetFileAccessTime();
